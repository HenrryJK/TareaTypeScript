...
/* TAREA 02*/
//// INSERTAR PRODUCTO
var producto = ["E01", "Carne de Res", 12.99, 12,
    "AA01", "Carnes Envasados"];
var producto2 = ["F02", "Leche Gloria", 9.76, 20,
    "BB02", "Lacteos y Leches"];
var producto3 = ["G01", "Inka Cola 1Lt", 6.99, 30,
...
//// MODIFICAR PRODUCTO///////
producto2.splice(0, 6, 'A02', "Pescados Salmon", 10.99, 60, "DD03", "Pescados y Mariscos");
console.log(producto2);
console.log(producto3);
////  BUSCAR PRODUCTO ///////
var posi = -1;
