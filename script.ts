 /* TAREA 01*/
 //// INSERTAR LIBROS
 let libreria = [124 , "JavaScript" ,"Henry Krunt" , 
 "Santillana" , 609];
 let libreria2 = [124 , "OLXHISTORIA" ,"Kevin Krunt" , 
 "Molitalia" , 505];
 let libreria3 = [59 , "Paco Yunque" ,"Francis Einst" , 
 "EditoPeru" , 152];
 ...
 //// MODIFICAR LIBROS///////
 libreria2.splice(0,5 , 306 , "The last Week V.1" , "Alejandro Magno"
 , "AMC-Studio" , 360);
 console.log(libreria2);
 console.log(libreria3);
